...
{
	FILE *f;
	f=fopen("/home/rihab/projectvol/uservol.txt","a+");
	if(f!=NULL)
	{
...
void afficher_vol(GtkWidget *liste)
{
	...
	if(store==NULL)
	{
		...
		f = fopen("/home/rihab/projectvol/uservol.txt", "r");
		if(f==NULL)
		{
			return;
		}
...
void afficher_hotel(GtkWidget *liste)
{
	...
	f = fopen("/home/rihab/projectvol/hotel.txt", "r");
		if(f==NULL)
		{
			return;
		}
		...
		{
		 f = fopen("/home/rihab/projectvol/hotel.txt","a+");
